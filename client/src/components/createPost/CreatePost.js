...
import { CloseIcon, CircularProgress } from '../../icon';

// context
import { Store } from '../../store/store';
import { AddPost, PostStart, PostFailure } from '../../store/actions';
                    ...
                    >
                        ...
                        <div className="cardContent">
                            ...
                            {chooseImg && (
                                <div className="cardContentImg">
                                    ...
                                    {img !== '' ? (
                                        <img
                                            className="cardContentImgPreview"
                                            alt=""
                                            src={img}
                                        />
                                    ) : (
                        ...
                        {feed.error && (
                            <div className="cardError">
                                <span className="cardErrorContent">
                                    {feed.error}
                                </span>
                            </div>
                        )}
