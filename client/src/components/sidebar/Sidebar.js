      ...
      <div className="sidebarWrapper">
        <ul className="sidebarList">
          ...
          <li className="sidebarListItem">
            <PeopleIcon className="sidebarIcon" style={{ color: '#0055ff' }} />
          ...
          <li className="sidebarListItem">
            <GroupsIcon className="sidebarIcon" style={{ color: '#00ff22' }} />
            <span className="sidebarListItemText">Groups</span>
          </li>
          <li className="sidebarListItem">
            <StoreIcon className="sidebarIcon" style={{ color: '#ff9500' }} />
