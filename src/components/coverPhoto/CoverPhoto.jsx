...
import { UpdateUserStart, ChangeCoverPhotoSuccess } from "../../context/AuthContext/actions";
  ...
  return (
    <>
          ...
          <div className="editCoverPhotoContainer">
            ...
            <div className="editCoverPhotoBtnContainer">
              ...
              <div className="editCoverPhotoBtnWrapper">
                <div className="editCoverPhotoBtn editCoverPhotoBtnCancel" onClick={handleCancelClick}>
                  Cancel
                </div>
                <div className="editCoverPhotoBtn editCoverPhotoBtnSave" onClick={handleSaveClick}>
                  Save Changes
                </div>
              </div>
            </div>
      ...
      {!imageFile && !user.coverPicture && editableInfo && (
        <label className="chooseCoverPhotoAlternative" htmlFor="coverPhoto"></label>
      )}
    </>
  );
}
