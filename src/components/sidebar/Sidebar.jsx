    ...
    <div className="sidebar">
      <div className="sidebarWrapper">
        <ul className="sidebarList">
          ...
          <li className="sidebarListItem">
            <OndemandVideo className="sidebarIcon" style={{ color: "#ff5100" }} />
            <span className="sidebarListItemText">Watch</span>
          </li>
          <li className="sidebarListItem">
            <WatchLaterRounded className="sidebarIcon" style={{ color: "#dd00ff" }} />
            <span className="sidebarListItemText">Memories</span>
          </li>
          <li className="sidebarListItem">
            <AssistantPhotoRounded className="sidebarIcon" style={{ color: "#808080" }} />
